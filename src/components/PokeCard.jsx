...
export default function PokeCard(props) {
  ...
  useEffect(() => {
    ...
    // check if the selected pokemon information available in the cache
    ...
    if (selectedPokemon in cache) {
      ...
      console.log('Foun pokemon in cache');

      return;
    }
    // we passed all the cache stuff to no available and now need to fetch the data from the api
